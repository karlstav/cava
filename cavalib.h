...
// cava_execute assumes cava_in to be replaced by all new samples at each execution
extern struct cava_plan *cava_init(int number_of_bars, unsigned int rate, int channels);
extern void cava_execute(int32_t *cava_in, double *cava_out, struct cava_plan *p);
